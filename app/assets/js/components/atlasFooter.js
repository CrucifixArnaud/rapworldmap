      ...
      <nav className="atlas-footer">
        <ul className="menu">
          <li className="menu__item menu__item--about-panel">
            ...
            <Modal ref="modalAbout" ariaLabelledby="aboutModalTitle" ariaDescribedby="" className="about-panel">
              <h2 id="aboutModalTitle" className="panel__title" tabIndex="0">About Rap World Map</h2>
