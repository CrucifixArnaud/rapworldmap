            ...
            <ClickOutHandler ref="aboutHandler" onClickOut={() => this.clickOutsideAbout()}>
              ...
              <div className={'about-panel ' + ((this.state.aboutOpen) ? 'open' : '')}>
                ...
                <div className="about-panel__body">
                  ...
                  <p>Check the source on <a href="">github</a></p>
                  <p>Rapworldmap.com is licensed under the terms of the MIT license. (<a href="https://opensource.org/licenses/MIT">https://opensource.org/licenses/MIT</a>)</p>
                </div>
              </div>
            </ClickOutHandler>
          </li>
