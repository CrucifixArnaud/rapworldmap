    ...
    switch(this.state.filters.clip) {
      case 'with-clip': {
        clipArtistFilter = publishedArtistFilter.filter( function (artist) {
          if(artist.youtube.clipExampleUrl !== undefined) {
  ...
  render() {
      ...
      return (
        <tr className='table__row' key={artist._id + step}>
          ...
          <td className="table__cell table__cell--action">
            <a href={'/admin/artists/' + artist.slug + '/edit'} className="button--primary">Edit</a>
    ...
    return (
      <div className="admin-content">
        <a className='button--primary--md' href='/admin/artists/create/'>Create a new artist</a>
